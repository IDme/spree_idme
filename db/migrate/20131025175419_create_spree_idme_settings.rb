class CreateSpreeIdmeSettings < ActiveRecord::Migration
  def change
    ...
    SpreeIdmeSetting.create!({:military_button => "https://s3.amazonaws.com/idme/buttons/troop_red_squ_40.png", :student_button => "https://s3.amazonaws.com/idme/buttons/student_gray2_squ_40.png", :responder_button => "https://s3.amazonaws.com/idme/buttons/responder_gray2_squ_40.png"}, :without_protection => true)
  end
end
