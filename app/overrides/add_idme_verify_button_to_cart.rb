Deface::Override.new(:virtual_path => 'spree/orders/edit',
                     ...
                     :text =>
                       "<% if current_order.idme_verified %>
                          <p><img src='/verified.png' alt='Verified by ID.me' />
                          Your <%= current_order.idme_scope %> affiliation has been verified. <br />
                          <%= link_to 'Remove Promotion', '/idme/deactivate' %></p>
                        <% else %>
                          ...
                          <% @affinity_groups.each do |group| %>
                            ...
                            <% end %>
                          <% end %>
                          &nbsp;&nbsp;&nbsp;<img src='/verified.png' alt='ID.me Verified'>
                          <br />
                          <br />
                        <% end %>",
